...
<ChartContainer title="GA4 Recruitment Funnel Setup">
  <TimelineChart
    steps={[
      { title: "Add GA4 Code", description: "Install tracking on careers site" },
      { title: "Set Up Goals", description: "Define conversion events" },
      { title: "Create Funnel", description: "Map application stages" },
      { title: "Analyse Drop-off", description: "Identify problem areas" }
    ]}
    color="primary"
  />
</ChartContainer>
