...
<ChartContainer title="Passive vs Active Candidates: Key Differences">
  <ComparisonTable
    weakLabel="Active Candidates"
    strongLabel="Passive Candidates"
    rows={[
...
<ChartContainer title="Passive Candidate Nurture Sequence">
  <TimelineChart
    steps={[
      { title: "Initial Outreach", description: "Personalised, no pressure", duration: "Day 1" },
      { title: "Share Value", description: "Industry insights, content", duration: "Ongoing" },
      { title: "Check In", description: "Quarterly touchpoints", duration: "3-6 months" },
      { title: "Convert", description: "When timing aligns", duration: "When ready" }
    ]}
    color="accent"
  />
</ChartContainer>
